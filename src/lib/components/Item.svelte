<script lang="ts">
	...
	import { updateItemQuery } from '$lib/pocketbase';
...
>
	<div class="flex flex-row justify-between items-center">
		<button class="flex gap-4 py-2 flex-grow mr-8" on:click={togglePickedItem}>
			<div class="w-4 text-right text-gray-700">{item.quantity}</div>
			<div
				class="text-gray-700 text-left font-semibold sm:w-[360px] truncate whitespace-nowrap
